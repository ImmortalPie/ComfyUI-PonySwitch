    ...
    def INPUT_TYPES():
        return {
            "required": {
                ...
                "Positive Pony Tags": ("STRING", {"default": "score_9, score_8_up, score_7_up,", "multiline": True}),
                "Negative Pony Tags": ("STRING", {"default": "score_4, score_5, score_6", "multiline": True}),
